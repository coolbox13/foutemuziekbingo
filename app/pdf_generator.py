...
class BingoCardPDF:
    ...
    def create_card_table(self, card_id, card_data):
        header_style = ParagraphStyle("HeaderStyle", parent=self.styles["Heading1"], fontSize=36, alignment=TA_CENTER, textColor=colors.white, fontName="Helvetica-Bold")
        ...
        table = Table(data, colWidths=[col_width] * 5, rowHeights=[header_height] + [content_row_height] * 5)
        ...
        table_style = TableStyle([
            ...
            # Color matched cells
            *[("BACKGROUND", (pos % 5, pos // 5 + 1), (pos % 5, pos // 5 + 1), colors.lightgreen) 
            for pos in matches]
        ])
