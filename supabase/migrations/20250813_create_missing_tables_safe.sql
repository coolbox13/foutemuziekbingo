-- Safe migration: Create missing tables for enhanced state management system
-- This migration only creates new tables and functions, no destructive operations
...
create index idx_game_states_last_activity on public.game_states(last_activity);
create index idx_game_states_created_at on public.game_states(created_at);
...
create index idx_saved_games_user_id on public.saved_games(user_id);
create index idx_saved_games_filename on public.saved_games(filename);
create index idx_saved_games_created_at on public.saved_games(created_at);
create index idx_saved_games_is_public on public.saved_games(is_public);
...
create table public.state_migrations (
    id uuid default gen_random_uuid() primary key,
...
create index idx_state_migrations_migration_id on public.state_migrations(migration_id);
create index idx_state_migrations_status on public.state_migrations(status);
create index idx_state_migrations_created_at on public.state_migrations(created_at);
...
-- Create RLS policies for saved_games
create policy "saved_games_select"
...
-- Create RLS policies for state_migrations (service role only)
create policy "state_migrations_service_only"
