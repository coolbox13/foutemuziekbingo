...
from app.models import (
    UserBase, User, UserCreate, UserUpdate,
    Game, GameCreate, GameUpdate, GameStatus,
    SpotifyUserProfile, SpotifyTokens,
    Playlist, Track, BingoCard,
    SubscriptionType
)
...
class TestUserModels:
    ...
    def test_spotify_id_validation_too_short(self):
        ...
        with pytest.raises(ValueError, match="Spotify ID must be at least 3 characters"):
